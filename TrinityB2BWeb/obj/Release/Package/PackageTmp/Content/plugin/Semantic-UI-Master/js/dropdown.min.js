...
! function (e, t, n, i) {
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.dropdown = function (a) {
        ...
        return s.each(function (f) {
            var g, p, b, w, x, S, C, y, A = e.isPlainObject(a) ? e.extend(!0, {}, e.fn.dropdown.settings, a) : e.extend({}, e.fn.dropdown.settings),
                T = A.className,
                k = A.message,
                L = A.fields,
                I = A.keys,
            ...
            y = {
                ...
                observe: {
                    select: function () {
                        y.has.input() && S.observe(U[0], {
                            childList: !0,
                            subtree: !0
                        })
                    },
                    menu: function () {
                        y.has.menu() && C.observe(W[0], {
                            childList: !0,
                            subtree: !0
                        })
                    }
                ...
                filterItems: function (t) {
                    ...
                    y.has.query() && (a = [], y.verbose("Searching for matching values", n), $.each(function () {
                        ...
                        if ("both" == A.match || "value" == A.match) {
                            ...
                            if (A.fullTextSearch === !0 && y.fuzzySearch(n, i)) return a.push(this), !0
                        }
                ...
                forceSelection: function () {
                    var e = $.not(T.filtered).filter("." + T.selected).eq(0),
                        ...
                        n = e.length > 0 ? e : t,
                        i = n.length > 0;
                    return i && !y.is.multiple() ? (y.debug("Forcing partial selection to selected item", n), void y.event.item.click.call(n, {}, !0)) : void (A.allowAdditions ? (y.set.selected(y.get.query()), y.remove.searchTerm()) : y.remove.searchTerm())
                },
                event: {
                    change: function () {
                ...
                set: {
                    ...
                    value: function (e, t, n) {
                        ...
                        if (o) {
                            ...
                            y.is.single() && y.has.selectInput() && y.can.extendSelect() && (y.debug("Adding user option", e), y.add.optionValue(e)), y.debug("Updating input value", a, s), G = !0, U.val(a), A.fireOnInit === !1 && y.is.initialLoad() ? y.debug("Input native change event ignored on initial load") : y.trigger.change(), G = !1
                        } else y.verbose("Storing value in metadata", a, U), a !== s && P.data(D.value, r);
                ...
                add: {
                    ...
                    optionValue: function (t) {
                        var n = y.escape.value(t),
                            ...
                            a = i.length > 0;
                        a || (y.disconnect.selectObserver(), y.is.single() && (y.verbose("Removing previous user addition"), U.find("option." + T.addition).remove()), e("<option/>").prop("value", n).addClass(T.addition).html(t).appendTo(U), y.verbose("Adding user addition as an <option>", t), y.observe.select())
                    },
                ...
                remove: {
                    ...
                    optionValue: function (e) {
                        var t = y.escape.value(e),
                            ...
                            i = n.length > 0;
                        i && n.hasClass(T.addition) && (S && (S.disconnect(), y.verbose("Temporarily disconnecting mutation observer")), n.remove(), y.verbose("Removing user addition as an <option>", t), S && S.observe(U[0], {
                            childList: !0,
                            subtree: !0
                        }))
                    },
                    ...
                    label: function (e, t) {
                        var n = P.find(O.label),
                            i = n.filter("[data-" + D.value + '="' + y.escape.string(e) + '"]');
                ...
                has: {
                    ...
                    label: function (e) {
                        var t = y.escape.value(e),
                            n = P.find(O.label);
                        return n.filter("[data-" + D.value + '="' + y.escape.string(t) + '"]').length > 0
                    },
                ...
                is: {
                    ...
                    onScreen: function (e) {
                        ...
                        }, y.is.verticallyScrollableContext() && (t.menu.offset.top += t.context.scrollTop), a = {
                    ...
                    verticallyScrollableContext: function () {
                        var e = z.get(0) !== t ? z.css("overflow-y") : !1;
